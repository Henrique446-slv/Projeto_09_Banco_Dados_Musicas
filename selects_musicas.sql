...
insert into musicas (titulo,artista,album,genero,duracao_segundos,ano_lancamento,streaming_count) values ('opção','mc kevin','passado e presente','funk',14.880,2021,200000000000)
-- 12 .Adicione qualquer música de Funk que o professor odeia
insert into musicas (titulo,artista,album,genero,duracao_segundos,ano_lancamento,streaming_count) values ('opção','mc kevin','passado e presente','funk',14.880,2021,200000000000)
-- 13. remova essa música que você acabou de adicionar.
delete from musicas where id = 120
